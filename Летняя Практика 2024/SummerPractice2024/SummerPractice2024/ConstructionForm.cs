    ...
    public partial class ConstructionForm : Form
    {
        ...
        private void helpButton_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Для добавления блока или окна зажмите левую кнопку мыши и протяните до ожидаемого правого нижнего угла.\n" +
                            "Чтобы удалить последнюю добавленную деталь, нажмите комбинацию клавиш Ctrl-Z.\n" +
                            "Чтобы закончить добавлять выбранную деталь ещё раз нажмите на кнопку.\n" +
                            "Кнопка \"Настроить цвета\" позволяет выбрать цвет для следующей добавленной детали.\n" +
                            "Детали добавляются на блоки и не могут пересекаться между собой, блоки также между собой не пересекаются.",
